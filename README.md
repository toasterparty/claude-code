...
- [output-styles/concise-plus-iambic.md](./claude-code/output-styles/concise-plus-iambic.md) - Concise+ with every line of prose in iambic pentameter
- [output-styles/concise-plus-trochaic.md](./claude-code/output-styles/concise-plus-trochaic.md) - Concise+ with every line of prose in trochaic pentameter
